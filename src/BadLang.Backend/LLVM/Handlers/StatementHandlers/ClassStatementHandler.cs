...
public class ClassStatementHandler : StatementHandler
{
    public ClassStatementHandler(CompilationSession session, IStatementCompiler statementCompiler, IExpressionCompiler expressionCompiler) 
